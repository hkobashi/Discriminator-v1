...
class Review(models.Model):
  ...
  appendedPicture = models.ImageField(upload_to='reviewPicture', null=True, blank=True)
...
def __str__(self):
  return "[%s]%s(%s)"%(self.id, self.title, self.body, self.user, self.appendedPicture)